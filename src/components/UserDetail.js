    ...
    <div className="mainContainer">
      ...
      <div className="innerContainer">
        <div className="left">
          ...
          />
          <div className="mb-3">
            <a className="imageClicks" onClick={handleProfileClick}>Profile</a>
          </div>
        </div>
          ...
          <div className={`center-form ${showForm ? "show" : ""}`}>
            <div className="formContainer fillbox">
              <form onSubmit={handleSubmit}>
                ...
                <div className="mb-3">
                  <input type="text" placeholder="Project Summary" name="projectSummary" value={formData.projectSummary} onChange={handleChange} />
                </div>
